...
@section('main')
    <section class="column w-full p-10 g-10">
         <form action="{{ url('admins/post/social/settings/process') }}" method="POST" onsubmit="PostRequest(event,this)" class="w-full p-10 g-5 column bg-white box-shadow br-10">
